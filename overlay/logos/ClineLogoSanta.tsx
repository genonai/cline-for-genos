...
/**
 * GenCode brand logo (GenOS symbol) — build-time overlay. Upstream ClineLogoSanta adds a festive
 * hat to the robot; GenCode drops the seasonal easter-egg and shows the plain GenOS mark.
 * Signature kept identical so HomeHeader compiles.
 */
