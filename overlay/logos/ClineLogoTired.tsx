...
/**
 * GenCode brand logo (GenOS symbol) — build-time overlay. Upstream ClineLogoTired renders a
 * sleepy robot for "Lazy Teammate Mode"; GenCode drops the mascot easter-egg and shows the
 * plain GenOS mark. Signature kept identical so HomeHeader compiles.
 */
